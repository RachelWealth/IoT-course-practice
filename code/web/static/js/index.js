...
var mydiv=document.getElementById('tableDis');
var datas=JSON.parse(mydiv.getAttribute('mydatas'));
...
for (var i = 0; i < (datas.length/4)+1; i++) {
            ...
            for(var ii = 0; ii < numEveryRow && (data<num); ii++){
            	...
            	if( jj == 0){
            			...
            			if(datas[0]['type']=='cloth'){
            				var imgUrl = 'static\\img\\cloth\\' + datas[data]['id'] + '.jpg';
            			}
            			else if(datas[0]['type']=='flavoring'){
            				var imgUrl = 'static\\img\\flavoring\\' + datas[data]['id'] + '.jpg';
            			}
            			else if(datas[0]['type']=='book'){
            				var imgUrl = 'static\\img\\book\\' + datas[data]['id'] + '.jpg';
            			...
            			if(datas[0]['type']=='cloth'){
            				...
            				myP.innerHTML=datas[data]["author"];
            			}
            			...
            			if(datas[0]['type']=='cloth'){
            				...
            				myP.innerHTML=datas[data]["language"] + '   ' + datas[data]["publisher"];
            			}
            			subTd.appendChild(myP);
            		}
            		else if(jj == 3){
