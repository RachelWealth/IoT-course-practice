...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBoxUseExterCam_2 = QtWidgets.QCheckBox(self.tab_2)
        self.checkBoxUseExterCam_2.setGeometry(QtCore.QRect(10, 250, 131, 40))
        self.checkBoxUseExterCam_2.setObjectName("checkBoxUseExterCam_2")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBoxUseExterCam_2.setText(_translate("Dialog", "使用外接摄像头"))
